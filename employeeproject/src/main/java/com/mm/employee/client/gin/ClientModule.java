...
package com.mm.employee.client.gin;

import com.mm.employee.client.application.ApplicationModule;
...
public class ClientModule extends AbstractPresenterModule {
    ...
    protected void configure() {
        ...
        bindConstant().annotatedWith(DefaultPlace.class).to(NameTokens.menu);
